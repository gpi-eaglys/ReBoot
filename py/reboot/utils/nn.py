...
import reboot_py
from reboot.layers.activations import PolyReLU, Square
from reboot.layers.modules import Module
from reboot.optim.optimizers import SGD, EncryptedNesterovSGD, Optimizer, PlainNesterovSGD
...
def l2_loss_encrypted(y_true: Array, y_pred: Array, n_cols: int) -> Array:
    return reboot_py.enc_l2_loss(y_true, y_pred, n_cols)
...
def l2_loss_grad_encrypted(y_true: Array, y_pred: Array) -> Array:
    return reboot_py.enc_l2_loss_grad(y_true, y_pred)
