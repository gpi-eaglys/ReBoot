...
from reboot.utils.train import epoch_log, train_step_plain, validation_plain, wandb_init
...
if __name__ == "__main__":
    ...
    for i in range(args.num_runs):
        ...
        mask_train = np.isin(labels_train, classes)
        X_train = X_train[mask_train]
        y_train = y_train[mask_train]

        labels_test = y_test.argmax(axis=1)
        mask_test = np.isin(labels_test, classes)
